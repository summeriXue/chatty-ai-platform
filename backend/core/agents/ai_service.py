...
def _build_system_prompt(
    ...
    if training_mode:
        ...
        parts.extend([
            ...
            "- Always use the language of the user's latest actual message for ALL user-visible natural-language output, including tool-use preambles, progress updates, intermediate explanations, follow-up questions, and the final answer.",
            "- The language used earlier in the conversation does not determine the response language. If the user switches languages, switch to the language of their latest actual message immediately and keep using it throughout the entire response.",
            "- Keep code, commands, API names, file paths, identifiers, model names, product names, and technical terms unchanged when appropriate.",
            "",
            "# How You Work",
            "",
